...
SHADOW-TD is a Python package for general-relativistic ray-tracing imaging of black hole shadows with geometrically thick accretion disks.
...
## Run the main pipeline from the project's root directory
`python run_all.py`
